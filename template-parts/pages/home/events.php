        ...
        <?php if (have_rows('events_list')) : ?>
            <div class="swiper events-swiper w-full mt-8 relative overflow-hidden">
                <div class="swiper-wrapper">
                    ...
                    ?>
                        <div class="swiper-slide min-h-[300px] md:min-h-0 px-8 md:px-0 relative bg-cover bg-center aspect-[16/5] flex items-center justify-center text-center" style="background-image: url('<?php echo esc_url($image_url[0]); ?>');">
